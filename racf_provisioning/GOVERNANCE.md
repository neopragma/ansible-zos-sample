...
**Note:** This document is based on an Open Mainframe Project template. The project has not yet been approved by the Open Mainframe Project. These guidelines are subject to change depending on whether this project is accepted into the Open Mainframe Project.
